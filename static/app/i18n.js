...
const translations = {
    'zh-CN': {
        ...
        'config.advanced.emptyResponseMaxRetries': '空响应最大重试次数',
        'config.advanced.emptyResponseMaxRetriesNote': '上游返回空响应(无文本/无工具/无思考)时的最大重试次数，默认 5 次',
        'config.advanced.emptyResponseRetryDelayMs': '空响应重试延迟(毫秒)',
        'config.advanced.emptyResponseRetryDelayMsNote': '空响应重试前的等待时间，默认 500 毫秒',
        ...
        'usage.codex.primaryWindow': '5小时限制',
        'usage.codex.secondaryWindow': '每周限制',
        'usage.remainingPrefix': '剩余',
        'usage.remainingPrefixShort': '余',
        'usage.usedPrefix': '已用',
        'usage.antigravity.geminiWeekly': 'Gemini 模型 - 每周限制',
        'usage.antigravity.gemini5h': 'Gemini 模型 - 5小时限制',
        'usage.antigravity.claudeWeekly': 'Claude/GPT 模型 - 每周限制',
        'usage.antigravity.claude5h': 'Claude/GPT 模型 - 5小时限制',
        ...
        'playground.reasoningEffort': '思考程度 (Reasoning Effort)',
        ...
        'customModels.table.sortTooltip': '点击按“模型 ID / 别名”排序',
        'customModels.table.sortAscTooltip': '当前按“模型 ID / 别名”升序，点击切换为降序',
        'customModels.table.sortDescTooltip': '当前按“模型 ID / 别名”降序，点击恢复默认排序',
        ...
        'customModels.table.status': '启用状态',
        'customModels.table.actions': '操作',
        'customModels.status.enabled': '已启用',
        'customModels.status.disabled': '已禁用',
        'customModels.form.enabled': '启用该模型',
    ...
    'en-US': {
        ...
        'config.advanced.emptyResponseMaxRetries': 'Empty Response Max Retries',
        'config.advanced.emptyResponseMaxRetriesNote': 'Maximum retries when upstream returns empty response (no text/tool/thinking), default is 5',
        'config.advanced.emptyResponseRetryDelayMs': 'Empty Response Retry Delay (ms)',
        'config.advanced.emptyResponseRetryDelayMsNote': 'Delay before retrying after empty response, default is 500ms',
        ...
        'usage.codex.primaryWindow': '5-Hour Limit',
        'usage.codex.secondaryWindow': 'Weekly Limit',
        'usage.remainingPrefix': 'Remaining',
        'usage.remainingPrefixShort': 'Rem ',
        'usage.usedPrefix': 'Used',
        'usage.antigravity.geminiWeekly': 'Gemini Models - Weekly Limit',
        'usage.antigravity.gemini5h': 'Gemini Models - 5-Hour Limit',
        'usage.antigravity.claudeWeekly': 'Claude/GPT Models - Weekly Limit',
        'usage.antigravity.claude5h': 'Claude/GPT Models - 5-Hour Limit',
        ...
        'customModels.table.sortTooltip': 'Click to sort by Model ID / Alias',
        'customModels.table.sortAscTooltip': 'Currently sorted by Model ID / Alias ascending. Click to sort descending.',
        'customModels.table.sortDescTooltip': 'Currently sorted by Model ID / Alias descending. Click to reset order.',
        ...
        'customModels.table.status': 'Status',
        'customModels.table.actions': 'Actions',
        'customModels.status.enabled': 'Enabled',
        'customModels.status.disabled': 'Disabled',
        'customModels.form.enabled': 'Enable this model',
